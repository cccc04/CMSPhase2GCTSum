...
begin
  ...
  PORT MAP (
    ...
    link_in_64_TUSER => link_in_master(64).tUser,
    link_in_64_TDATA => link_in_master(64).tData,
    link_in_64_TVALID => link_in_master(64).tValid,
    link_in_64_TLAST(0) => link_in_master(64).tLast,
    link_in_64_TREADY => link_in_slave(64).tReady,
    link_in_65_TUSER => link_in_master(65).tUser,
    link_in_65_TDATA => link_in_master(65).tData,
    link_in_65_TVALID => link_in_master(65).tValid,
    link_in_65_TLAST(0) => link_in_master(65).tLast,
    link_in_65_TREADY => link_in_slave(65).tReady,
    link_in_66_TUSER => link_in_master(66).tUser,
    link_in_66_TDATA => link_in_master(66).tData,
    link_in_66_TVALID => link_in_master(66).tValid,
    link_in_66_TLAST(0) => link_in_master(66).tLast,
    link_in_66_TREADY => link_in_slave(66).tReady,
    link_in_67_TUSER => link_in_master(67).tUser,
    link_in_67_TDATA => link_in_master(67).tData,
    link_in_67_TVALID => link_in_master(67).tValid,
    link_in_67_TLAST(0) => link_in_master(67).tLast,
    link_in_67_TREADY => link_in_slave(67).tReady,
    link_in_68_TUSER => link_in_master(68).tUser,
    link_in_68_TDATA => link_in_master(68).tData,
    link_in_68_TVALID => link_in_master(68).tValid,
    link_in_68_TLAST(0) => link_in_master(68).tLast,
    link_in_68_TREADY => link_in_slave(68).tReady,
    link_in_69_TUSER => link_in_master(69).tUser,
    link_in_69_TDATA => link_in_master(69).tData,
    link_in_69_TVALID => link_in_master(69).tValid,
    link_in_69_TLAST(0) => link_in_master(69).tLast,
    link_in_69_TREADY => link_in_slave(69).tReady,
    link_in_70_TUSER => link_in_master(70).tUser,
    link_in_70_TDATA => link_in_master(70).tData,
    link_in_70_TVALID => link_in_master(70).tValid,
    link_in_70_TLAST(0) => link_in_master(70).tLast,
    link_in_70_TREADY => link_in_slave(70).tReady,
    link_in_71_TUSER => link_in_master(71).tUser,
    link_in_71_TDATA => link_in_master(71).tData,
    link_in_71_TVALID => link_in_master(71).tValid,
    link_in_71_TLAST(0) => link_in_master(71).tLast,
    link_in_71_TREADY => link_in_slave(71).tReady,
